...
|---|---|---|---|---|
| 1 | 30. 6. | servo samo do ~0.9 m, zatim ravni dovoz + mjerenje dubinom (dubina ne pati od kuta) | pouzdan prilaz | rješenje |
| 2 | 16. 7. | mjerenje s 0.95 m **prije** dovoza, dovoz korigiran odometrijom | točan centar nakon dovoza | poboljšanje ([[P-22_depth_self_view_clusters]]) |
