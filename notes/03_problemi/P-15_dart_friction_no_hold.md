...
|---|---|---|---|---|
| 1 | 30. 6. | μ kutije 2.0, efort stiska 120, bez DetachableJointa | ne digne se | — |
| 2 | 30. 6. | μ do 5, masa 0.4 → 0.2 kg, kp | ne digne se | trenje iscrpljeno |
| 3 | 30. 6. | DetachableJoint tek nakon kontakt-provjere (odobrio korisnik) | digne se, drži | **trenutno** ([[D-05_contact_verified_attach]]) |
